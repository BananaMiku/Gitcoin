...
static PyObject *test_cuda_py(PyObject *self, PyObject *args) {
    std::cout << "CUDA START" << std::endl << std::flush;
    test_cuda();
    std::cout << "CUDA END" << std::endl << std::flush;
    Py_RETURN_NONE;
    return NULL;
}
...
static PyMethodDef methods[] = {
    ...
    {"test_cuda_py", test_cuda_py, METH_VARARGS, "help me"},
